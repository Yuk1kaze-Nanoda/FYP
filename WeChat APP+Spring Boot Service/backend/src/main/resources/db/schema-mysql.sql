...
CREATE TABLE IF NOT EXISTS sensor_logs (
  ...
  created_at DATETIME(6) NOT NULL,
  PRIMARY KEY (id),
  KEY idx_sensor_logs_user_created_at (user_id, created_at),
  CONSTRAINT fk_sensor_logs_user FOREIGN KEY (user_id) REFERENCES users (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS operation_logs (
  ...
  created_at DATETIME(6) NOT NULL,
  PRIMARY KEY (id),
  KEY idx_operation_logs_user_created_at (user_id, created_at),
