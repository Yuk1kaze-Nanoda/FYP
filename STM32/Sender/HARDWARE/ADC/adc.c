...
{    
	...
	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_0|GPIO_Pin_1;        //准备设置PA5 6 7
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		                   //模拟输入引脚
	GPIO_Init(GPIOB, &GPIO_InitStructure);                                 //设置PA5 6 7
	
	GPIO_InitStructure.GPIO_Pin =GPIO_Pin_0 ;        //准备设置PA5 6 7
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		                   //模拟输入引脚
