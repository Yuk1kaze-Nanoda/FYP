...
void MQTT_Init(void)
{
	...
	{
		u2_printf("Net Init OK!\r\n");
		status++;
	}
	else
	{
		u2_printf("Net Init Error!\r\n");
		status=0;
	}
	if(status==1)  		//连接热点
	{
		...
		{
			u2_printf("Conncet AP OK!\r\n");
			status++;
		}
		else 
		{
			u2_printf("Conncet AP Error!\r\n");
			status=0;
		}
	}
	if(status==2)      //连接TCP
	{	
		...
		{
			u2_printf("Conncet Server OK!\r\n");
			status++;
		}
		else
		{
			u2_printf("Conncet Server Error!\r\n");		
		}
	}
	if(status==3)  	//登录MQTT	
	{
		...
		{
			u2_printf("Enter MQTT OK!\r\n");
			status++;
		}
		else
		{
			u2_printf("Enter MQTT Error!\r\n");
			status=0;
		}	
	}	
	if(status==4)  		//订阅主题
	{
		...
		{
			u2_printf("SubscribeTopic OK!\r\n");
		}
		else
		{			
			u2_printf("SubscribeTopic Error!\r\n");
		}
	}
	status = 0;
}
